        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 2xl:gap-20 items-center">
          ...
          <div className="lg:col-span-7 text-left space-y-4 sm:space-y-6 2xl:space-y-10">
            ...
            >
              ...
              <a 
                href="#about"
                className="inline-flex items-center justify-center gap-2 px-8 py-3.5 2xl:px-10 2xl:py-4.5 rounded-full text-sm 2xl:text-base font-bold text-primary border border-primary/20 bg-white/40 hover:bg-slate-100/50 backdrop-blur-sm transition-all duration-300"
              >
