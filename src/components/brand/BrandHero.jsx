...
const BrandHero = ({ brand, language }) => {
  ...
  if (brand.id === 'jetema' || brand.id === 'dermclar' || brand.id === 'xtralife') {
    ...
    const description = isJetema
      ? (isEs 
        ? 'Desarrollo científico de vanguardia y soluciones de bioestética premium para profesionales de la salud en Bolivia. Elevando el estándar del rejuvenecimiento médico con certificaciones internacionales.'
